...
layui.define("jquery", function (e) {
	...
	i = {
		fixbar : function (e) {
			...
			e.bar3 = e.bar3 === !0 ? "&#xe607;" : e.bar3,
			e.bar4 = e.bar4 === !0 ? "&#xe607;" : e.bar4,
			e.bar5 = e.bar5 === !0 ? "&#xe607;" : e.bar5;
			// e.bgcolor = e.bgcolor ? "background-color:" + e.bgcolor : "";
			var c = [e.bar1, e.bar2, e.bar3, e.bar4, e.bar5, "&#xe604;"],
			g = t(['<ul class="' + a + '">', 
				e.bar1 ? '<li class="layui-icon" lay-type="bar1" style="' + e.style + 'background-color:orange;">' + c[0] + "</li>" : "", 
				e.bar2 ? '<li class="layui-icon" lay-type="bar2" style="' + e.style + '">' + c[1] + "</li>" : "", 
				e.bar3 ? '<li class="layui-icon" lay-type="bar3" style="' + e.style + '">' + c[2] + "</li>" : "", 
				e.bar4 ? '<li class="layui-icon" lay-type="bar4" style="' + e.style + '">' + c[3] + "</li>" : "", 
				e.bar5 ? '<li class="layui-icon" lay-type="bar5" style="' + e.style + '">' + c[4] + "</li>" : "",
				'<li class="layui-icon ' + r + '" lay-type="top" style="' + e.style + '">' + c[5] + "</li>", 
				"</ul>"].join("")),
			s = g.find("." + r),
			u = function () {
				var t = n.scrollTop();
			...
			g.find("li").on("mouseover", function (li_i) {
				$(this).css("background-color", e.hover);	
			}),
			g.find("li").on("mouseout", function () {
				if($(this).attr('lay-type') != 'bar1'){
					$(this).css("background-color", e.bgcolor);	
				}
			}),
